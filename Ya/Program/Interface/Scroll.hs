...
instance Scrollable (Construction (Optional `T'TT'I` Construction Optional)) i where
 scroll way x = is
  ...
  vertical_deep _ = enter @(State `WR` Scrolling Tree i `JNT` Halts)
   ...
   `ho__'he'he` ((Scope @(Focused (Tree i)) at `ho'he'he'he'he`  Scope @(i `LM` _) it)
   ...
   `ho_'ha'he` Scope @((Reverse List `T'TT'I` (Only `LM'T'I'TT'I` Shafted List `T'TT'I` Tree)) i) at
   `ho'he'he` Scope @(List ((Only `LM'T'I'TT'I` Shafted List `T'TT'I` Tree) i)) at
  ...
  vertical_up _ = enter @(State `WR` Scrolling Tree i `JNT` Halts)
   ...
   `ha_'he` Scope @((Reverse List `T'TT'I_` (Only `LM'T'I'TT'I` Shafted List `T'TT'I` Tree)) i) at
   `ho'he'he` Scope @(List ((Only `LM'T'I'TT'I` Shafted List `T'TT'I` Tree) i)) at
   `yok___` Try `ha` Maybe
