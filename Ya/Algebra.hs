...
instance Covariant Semifunctor f Arrow Arrow => Transformation Flat f f Constant Arrow
...
instance Contravariant Semifunctor f Arrow Arrow => Transformation Dual f f Constant Arrow
...
instance (Covariant Semifunctor f Arrow Arrow, Transformation Flat (f `T_TT_I` g) f Arrow Arrow)
...
instance (Covariant Semifunctor g Arrow Arrow, Transformation Flat (g `T_TT_I` f) f Arrow Arrow) =>
