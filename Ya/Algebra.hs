...
instance
 ...
 mapping = rewrap `identity` \_ -> rewrap `identity` \(T'I' x) -> Only `ho'ut` T'I' x `ryo` Enter
...
instance
 ...
 ) => Mapping T'I'II T'I'II (AR) (AR) (Covariant Day (AR) (P) (P) (t `T'TT'I` tt) ((t `T'TT'I` tt) `L` (t `T'TT'I` tt) `T` (Void)) e ee) (t `T'TT'I` tt) where
 mapping = rewrap `identity` \source -> rewrap `identity` \case
  These (These (T'TT'I e) (Label (T'TT'I ee))) (T'I'II f) ->
    day @T'I'II @(AR) @Void @t @t @(P) @(P) identity
     (day @T'I'II @(AR) @Void @tt @tt @(P) @(P) identity (source `compose` f) `compose` fio @(AR) subtype)
      (These e (subtype ee))
...
instance
 ...
 , forall e ee . Covariant Transformation Functor (AR) (AR) (Covariant Day (AR) (P) (P) t (t `L` t `T` Void) e ee) t
 , Covariant Transformation Functor (AR) (AR) (tt `T'TT'I` t `L` t `T` l `L` tt `T` (Void)) (tt `TT'T'I` t)
 , Covariant Transformation Functor (AR) (AR) (ttt `T'TT'I` t `L` t `T` l `L` ttt `T` (Void)) (ttt `TT'T'I` t)
 , Covariant Endo Semi Functor (AR) tt
 , Covariant Endo Semi Functor (AR) ttt
 ) => Mapping T'I'II T'I'II (AR) (AR) ((tt `P'T'I'TT'I` ttt) `T'TT'I` t `L` t `T` l `L` (tt `P'T'I'TT'I` ttt) `T` (Void)) ((tt `P'T'I'TT'I` ttt) `TT'T'I` t) where
 mapping = rewrap `identity` \source -> rewrap (
  ...
  `compose` wrapped (map @T'I'II @T'I'II @(AR) @(AR) @(T'II'I (P) _) @(T'II'I (P) _)
   (wrapped (map @T'I'II @T'I'II @(AR) @(AR) @(tt `T'TT'I` t `L` t `T` l `L` tt `T` (Void)) @(tt `TT'T'I` t) source)
   `compose` map @T'I'II @T'I'II @(AR) @(AR) @tt @tt (rewrap @(AR) @(t `L` t `T` l `L` (tt `P'T'I'TT'I` ttt) `T` (Void) `T` _) @(t `L` t `T` l `L` tt `T` (Void) `T` _) identity)))
  `compose` wrapped (map @T'I'II @T'I'II @(AR) @(AR) @(T'I'II (P) _) @(T'I'II (P) _)
   (subtype @(AR) @(t `L` t `T` Void `T` _) `compose` wrapped (map @T'I'II @T'I'II @(AR) @(AR) @(ttt `T'TT'I` t `L` t `T` l `L` ttt `T` (Void)) @(ttt `TT'T'I` t) source)
   `compose` map @T'I'II @T'I'II @(AR) @(AR) @ttt @ttt (rewrap @(AR) @(t `L` t `T` l `L` (tt `P'T'I'TT'I` ttt) `T` (Void) `T` _) @(t `L` t `T` l `L` ttt `T` (Void) `T` _) identity)))
  `compose` supertype)

{-
-- fc: t (AR a o) -> (AR) (t a) (t o)
-- TODO: generalise up to any categories
instance
 ( forall e . Wrapper (AR) (t `L` t `T` l `T` e)
 , forall e . Covariant Endo Semi Functor (AR) (T'I'II (P) e)
 , forall e . Covariant Endo Semi Functor (AR) (T'II'I (P) e)
 , forall e ee . Covariant Transformation Functor (AR) (AR) (Covariant Day (AR) (P) (P) t (t `L` t `T` Void) e ee) t
 , Covariant Transformation Functor (AR) (AR) (tt `T'TT'I` t `L` t `T` l `L` tt `T` (Void `P` Void)) (tt `TT'T'I` t)
 , Covariant Transformation Functor (AR) (AR) (ttt `T'TT'I` t `L` t `T` l `L` ttt `T` (Void `P` Void)) (ttt `TT'T'I` t)
 , Covariant Endo Semi Functor (AR) tt
 , Covariant Endo Semi Functor (AR) ttt
 ) => Mapping T'I'II T'I'II (AR) (AR) ((tt `P'T'I'TT'I` ttt) `T'TT'I` t `L` t `T` l `L` (tt `P'T'I'TT'I` ttt) `T` (Void `P` Void)) ((tt `P'T'I'TT'I` ttt) `TT'T'I` t) where
 mapping = rewrap `identity` \source -> rewrap (
  day @T'I'II @(AR) @Void @t @t @(P) @(P) identity (\(These x xx) -> subtype @(AR) @(tt `P'T'I'TT'I` ttt `T'I___` _) `identity` (\xx' -> These x xx') xx)
  `compose` wrapped (map @T'I'II @T'I'II @(AR) @(AR) @(T'II'I (P) _) @(T'II'I (P) _)
   (wrapped (map @T'I'II @T'I'II @(AR) @(AR) @(tt `T'TT'I` t `L` t `T` l `L` tt `T` (Void `P` Void)) @(tt `TT'T'I` t) source)
   `compose` map @T'I'II @T'I'II @(AR) @(AR) @tt @tt (rewrap @(AR) @(t `L` t `T` l `L` (tt `P'T'I'TT'I` ttt) `T` (Void `P` Void) `T` _) @(t `L` t `T` l `L` tt `T` (Void `P` Void) `T` _) identity)))
  `compose` wrapped (map @T'I'II @T'I'II @(AR) @(AR) @(T'I'II (P) _) @(T'I'II (P) _)
   (subtype @(AR) @(t `L` t `T` Void `T` _) `compose` wrapped (map @T'I'II @T'I'II @(AR) @(AR) @(ttt `T'TT'I` t `L` t `T` l `L` ttt `T` (Void `P` Void)) @(ttt `TT'T'I` t) source)
   `compose` map @T'I'II @T'I'II @(AR) @(AR) @ttt @ttt (rewrap @(AR) @(t `L` t `T` l `L` (tt `P'T'I'TT'I` ttt) `T` (Void `P` Void) `T` _) @(t `L` t `T` l `L` ttt `T` (Void `P` Void) `T` _) identity)))
  `compose` supertype)
-}
...
instance
 ...
 mapping = rewrap `identity` \source -> rewrap `identity` \(T'TT'I'TTT'I (These x xx)) ->
  x `yo` subtype @(AR) @(ttt `L` ttt `T` lll `L` t `T` l `T` _)
     `ha` supertype @(AR) @(ttt `L` ttt `T` lll `L` T'TT'I'TTT'I P t tt `T` l `T` _)
     `yi` wrapped (map @T'I'II @T'I'II @(AR) @(AR) @(t `T'TT'I` ttt `L` ttt `T` lll `L` t `T` l) @(t `TT'T'I` ttt) source)
  `hjd_`
  xx `yo` subtype @(AR) @(ttt `L` ttt `T` lll `L` tt `T` l `T` _)
     `ha` supertype @(AR) @(ttt `L` ttt `T` lll `L` T'TT'I'TTT'I P t tt `T` l `T` _)
     `yi` wrapped (map @T'I'II @T'I'II @(AR) @(AR) @(tt `T'TT'I` ttt `L` ttt `T` lll `L` tt `T` l) @(tt `TT'T'I` ttt) source)
     `ho` subtype @(AR) @(ttt `L` ttt `T` lll `T` _)
...
instance
 ...
 mapping = rewrap `identity` \source -> rewrap `identity` \(T'TT'I'TTT'I x) -> case x of
  This xx -> xx
   `yo` subtype @(AR) @(ttt `L` ttt `T` ll `L` t `T` l `T` _)
  ...
  That xx -> xx
   `yo` subtype @(AR) @(ttt `L` ttt `T` ll `L` tt `T` l `T` _)
   `ha` supertype @(AR) @(ttt `L` ttt `T` ll `L` T'TT'I'TTT'I S t tt `T` l `T` _)
...
instance
 ...
 (Day T'I'II (AR) (P) (S) (F'T'I'TT (T'II'I P) (S'I'II Unit)) (F'T'I'TT (T'II'I P) (S'I'II Unit) `L` F'T'I'TT (T'II'I P) (S'I'II Unit) `T` Void) i ii)
 (F'T'I'TT (T'II'I P) (S'I'II Unit)) where
 mapping = rewrap `identity` \source -> rewrap `identity` \(These (These i ii) (T'I'II f)) ->
  let These xs x = supertype `compose` supertype `compose` supertype `compose` supertype `identity`i in
  let These ys _ = supertype `compose` supertype `compose` supertype `compose` supertype `compose` supertype `identity`ii in
  Recursive `compose` T'TT'I `compose` T'II'I `identity`These
   (day @T'I'II @(AR) @Void @(S'I'II Unit) @(S'I'II Unit) @(P) @P identity
    (supertype `compose` day @T'I'II @(AR) @Void @(F'T'I'TT (T'II'I P) _) @(F'T'I'TT (T'II'I P) _) @(P) @(S) identity (source `compose` f)
     `compose` fio (subtype `compose` F'T'I'TT) `compose` foi F'T'I'TT)
    `identity`These xs (subtype ys))
   (source `compose` f `identity`This x)

instance
 ( Covariant Lax Monoidal Functor (AR) (AR) (P) P Void (S'I'II Unit)
 -- , Covariant Endo Monoidal Functor (AR) (P) (S) Void (F'T'I'TT (T'II'I P) (S'I'II Unit))
 ) => Mapping T'I'II T'I'II (AR) (AR) (Day T'I'II (AR) (P) (S)
  (S'I'II Unit `T'TT'I` F'T'I'TT (T'II'I P) (S'I'II Unit))
  ((S'I'II Unit `T'TT'I` F'T'I'TT (T'II'I P) (S'I'II Unit)) `L` (S'I'II Unit `T'TT'I` F'T'I'TT (T'II'I P) (S'I'II Unit)) `T` Void)
 i ii)
 (S'I'II Unit `T'TT'I` F'T'I'TT (T'II'I P) (S'I'II Unit)) where
 mapping = rewrap `identity` \source -> rewrap `identity` \(These (These i (Label ii)) (T'I'II f)) ->
  (day @T'I'II @(AR) @Void @(S'I'II Unit) @(S'I'II Unit) @(P) @P identity
     (day @T'I'II @(AR) @Void @(F'T'I'TT (T'II'I P) _) @(F'T'I'TT (T'II'I P) _) @(P) @(S) identity (source `compose` f)
  `compose` fio @(AR) subtype)
     `har_` supertype i `hjd` subtype (supertype ii))

-- 1. t (F'T'I'TT (T'II'I P) t ((tt `L` tt `T` ll `L` (t `T'TT'I` F'T'I'TT (T'II'I P) t) `T` l `T` _)))
-- 2. t (tt (F'T'I'TT (T'II'I P) t _))
...
instance
 ...
 , Covariant Transformation Functor (AR) (AR) (F'T'I'TT (T'II'I P) t `T'TT'I` tt `L` tt `T` ll `L` F'T'I'TT (T'II'I P) t `T` l) (F'T'I'TT (T'II'I P) t `TT'T'I` tt)
 ) => Mapping T'I'II T'I'II (AR) (AR)
  ((t `T'TT'I` F'T'I'TT (T'II'I P) t) `T'TT'I` tt `L` tt `T` ll `L` (t `T'TT'I` F'T'I'TT (T'II'I P) t) `T` l)
  ((t `T'TT'I` F'T'I'TT (T'II'I P) t) `TT'T'I` tt) where
 mapping = rewrap `identity` \source -> rewrap `identity` \x -> supertype x
  `yo'yo` rewrap @(AR) @_ @(tt `L` tt `T` ll `L` F'T'I'TT (T'II'I P) t `T` l `T` _) identity
  `yo` wrapped (map @T'I'II @T'I'II @(AR) @(AR)
   @(F'T'I'TT (T'II'I P) t `T'TT'I` tt `L` tt `T` ll `L` F'T'I'TT (T'II'I P) t `T` l)
   @(F'T'I'TT (T'II'I P) t `TT'T'I` tt) source)
  `ho` subtype @(AR) @(tt `L` tt `T` ll `T` _)
...
-- 1. (F'T'I'TT (T'II'I P) t (L l tt _))
-- 2. tt  _ `P` t (Recursive (T'I'TT'II (P) t (L l tt _)))
-- 3. tt _ `P` t (F'T'I'TT (T'II'I P) t (L l tt _))
-- 4. tt _ `P` t (tt (F'T'I'TT (T'II'I P) t _))
-- 5. tt _ `P` t (L l tt (F'T'I'TT (T'II'I P) t _))
-- 6. tt _ `P` tt (t (F'T'I'TT (T'II'I P) t _))
-- 7. tt (F'T'I'TT (T'II'I P) t _)
...
instance
 ...
 ) => Mapping T'I'II T'I'II (AR) (AR) (F'T'I'TT (T'II'I P) t `T'TT'I` tt `L` tt `T` ll `L` F'T'I'TT (T'II'I P) t `T` (Void `P` Void)) (F'T'I'TT (T'II'I P) t `TT'T'I` tt) where
 mapping = rewrap `identity` \source -> rewrap `identity` \(F'T'I'TT (Recursive (T'TT'I (T'II'I (These xs x))))) ->
    (xs
      `yo` subtype @(AR) @(F'T'I'TT _ _ _)
      `ho` wrapped (map @T'I'II @T'I'II @(AR) @(AR)
        @(F'T'I'TT (T'II'I P) t `T'TT'I` tt `L` tt `T` ll `L` F'T'I'TT (T'II'I P) t `T` (Void `P` Void))
        @(F'T'I'TT (T'II'I P) t `TT'T'I` tt) source)
      `ho` subtype @(AR) @(tt `L` tt `T` ll `T` _)
      `ho` subtype @(AR) @(tt `L` tt `T` ll `L` t `T` (Void) `T` _)
      `yi` wrapped (map @T'I'II @T'I'II @(AR) @(AR) @(t `T'TT'I` tt `L` tt `T` ll `L` t `T` (Void)) @(t `TT'T'I` tt) (supertype @(AR) @(F'T'I'TT _ _ _)))
     `hjd_` supertype (supertype x) `yo` source `yi` subtype @(AR) @(_ `L` _ `T` Void `T` _))
     `yp_'yo` subtype @(AR) @(F'T'I'TT _ _ _)
      `ha` subtype @(AR) @(Recursive _)
      `ha` subtype @(AR) @(T'TT'I _ _ _)
      `ha` subtype @(AR) @(T'II'I _ _ _)
...
instance
 ...
 , Transformation T'I'II Functor (AR) (AR) (t `T'TT'I` tt `L` tt `T` ll `L` t `T` Void) (t `TT'T'I` tt)
  ...
  (F'T'I'TT (T'II'I P) t `T'TT'I` tt `L` tt `T` ll `L` F'T'I'TT (T'II'I P) t `T` (Void))
  (F'T'I'TT (T'II'I P) t `TT'T'I` tt) where
 mapping = rewrap `identity` \source -> rewrap
  `identity` \(F'T'I'TT (Recursive (T'TT'I (T'II'I (These xs x))))) ->
   (These
    `ho_'ho` (subtype @(AR) @(T'TT'I _ _ _) `compose` subtype @(AR) @(T'II'I _ _ _))
    `ho` subtype @(AR) @(Recursive _)
    `ho` subtype @(AR) @(F'T'I'TT _ _ _))
   `fo` (xs
      `yo` subtype @(AR) @(F'T'I'TT _ _ _)
      `ho` wrapped (map @T'I'II @T'I'II @(AR) @(AR)
       @(F'T'I'TT (T'II'I P) t `T'TT'I` tt `L` tt `T` ll `L` F'T'I'TT (T'II'I P) t `T` (Void))
    ...
    `fc` (supertype (supertype x) `yo` source)
...
instance
 ...
 , Covariant Transformation Functor (AR) (AR) (t `T'TT'I` tt `L` tt `T` ll `L` t `T` Void) (t `TT'T'I` tt)
  ...
  (F'T'I'TT (T'I'II S) t `T'TT'I` tt `L` tt `T` ll `L` F'T'I'TT (T'I'II S) t `T` Void)
  (F'T'I'TT (T'I'II S) t `TT'T'I` tt) where
 mapping = rewrap `identity` \source -> rewrap `identity` \(F'T'I'TT (Recursive (T'TT'I (T'I'II x)))) -> case x of
  This xx -> supertype (supertype xx) `yo` F'T'I'TT `ha` Recursive `ha` T'TT'I `ha` T'I'II `ha` This `ha` source
  That xx -> xx
   `yo` F'T'I'TT
   `ho` wrapped (map @T'I'II @T'I'II @(AR) @(AR)
    @(F'T'I'TT (T'I'II S) t `T'TT'I` tt `L` tt `T` ll `L` F'T'I'TT (T'I'II S) t `T` Void)
    @(F'T'I'TT (T'I'II S) t `TT'T'I` tt) source)
   `ho` subtype @(AR) @(tt `L` tt `T` ll `T` _)
   `ho` subtype @(AR) @(tt `L` tt `T` ll `L` t `T` Void `T` _)
   `yi` wrapped (map @T'I'II @T'I'II @(AR) @(AR)
     @(t `T'TT'I` tt `L` tt `T` ll `L` t `T` Void)
     @(t `TT'T'I` tt)
     (supertype @(AR) @(F'T'I'TT _ _ _)))
   `yo` F'T'I'TT `ha` Recursive `ha` T'TT'I `ha` T'I'II `ha` That

-- TODO: try to simplify
instance
 ( Covariant Lax Monoidal Functor (AR) (AR) (P) P Void t
 , Covariant Lax Monoidal Functor (AR) (AR) (P) P Void (F'T'I'TT (T'II'I P) t)
 ) => Mapping T'I'II T'I'II (AR) (AR) (Day T'I'II (AR) (P) P (F'T'I'TT (T'II'I P) t) (F'T'I'TT (T'II'I P) t `L` F'T'I'TT (T'II'I P) t `T` Void) e ee) (F'T'I'TT (T'II'I P) t) where
 mapping = rewrap `identity` \source -> rewrap `identity` \case
  These (These e ee) (T'I'II f) ->
   let These e__ e_ = supertype `compose` supertype `compose` supertype `compose` supertype `identity`e in
   let These ee__ ee_ = supertype `compose` supertype `compose` supertype `compose` supertype `compose` supertype `identity`ee in
   Recursive `compose` T'TT'I `compose` T'II'I `identity`These
    (day @T'I'II @(AR) @Void @t @t @(P) @P identity
     (supertype
      `compose` day @T'I'II @(AR) @Void @(F'T'I'TT (T'II'I P) t) @(F'T'I'TT (T'II'I P) t) @(P) @P identity (source `compose` f)
      `compose` fio (subtype `compose` F'T'I'TT)
      `compose` foi F'T'I'TT)
     `identity`These e__ (subtype ee__))
    (source `compose` f `identity`These e_ ee_)

instance (Initial (AR), Covariant Lax Monoidal Functor (AR) (AR) (P) (S) Void t) =>
 Mapping T'I'II T'I'II (AR) (AR) (T'I'II (AR) Unit) (F'T'I'TT (T'II'I P) t) where
 mapping = rewrap `identity` \source (T'I'II f) ->
  initial @(AR) `ryo` Enter @t `hjd_'tb` source `har'st` f
...
-- TODO: replace a representing object with (i `S` i)

-- instance (Initial (AR), Covariant Lax Monoidal Functor (AR) (AR) (P) (S) Void t) =>
-- instance
 -- Mapping T'I'II T'I'II (AR) (AR) (T'I'II (AR) (Void `P` i) (t `T'TT'I` tt) =>
 -- Mapping T'I'II T'I'II (AR) (AR) (T'I'II (AR) Void) (t `T'TT'I` tt) where
 -- mapping = rewrap `identity` \_ -> rewrap `identity` \f -> T'TT'I (None `ho` initial @(AR) `ryo` Enter)

-- TODO: remove later in favour of more generalised approach
instance (Initial (AR), Covariant Lax Monoidal Functor (AR) (AR) (P) (S) Void t) =>
 Mapping T'I'II T'I'II (AR) (AR) (T'I'II (AR) Void) (t `T'TT'I` F'T'I'TT (T'II'I P) tt) where
 mapping = rewrap `identity` \_ _ -> T'TT'I (empty @t `yo` initial @(AR))

-- Mapping T'I'II T'I'II (AR) (AR) (T'I'II (AR) Unit) (F'T'I'TT (T'II'I P) Maybe) where
-- _ `S` Unit

-- Mapping T'I'II T'I'II (AR) (AR) (T'I'II (AR) Unit) (F'T'I'TT (T'II'I P) List) where

-- instance
 -- ( Covariant Lax Monoidal Functor (AR) (AR) (P) P Void t
 -- , Covariant Lax Monoidal Functor (AR) (AR) (P) P Void (F'T'I'TT (T'II'I P) t)
 -- ) => Mapping T'I'II T'I'II (AR) (AR) (Day T'I'II (AR) (P) P (t `T'TT'I` F'T'I'TT (T'II'I P) t) ((t `T'TT'I` F'T'I'TT (T'II'I P) t) `L` (t `T'TT'I` F'T'I'TT (T'II'I P) t) `T` Void) e ee) (t `T'TT'I` F'T'I'TT (T'II'I P) t) where
 -- mapping = rewrap `identity` \source -> rewrap `identity` \case
  -- These (These (T'TT'I e) (Label (T'TT'I ee))) (T'I'II f) ->
    -- day @T'I'II @(AR) @Void @t @t @(P) @P identity
     -- (day @T'I'II @(AR) @Void @(F'T'I'TT (T'II'I P) t) @(F'T'I'TT (T'II'I P) t) @(P) @P identity (source `compose` f) `compose` fio @(AR) subtype)
      -- (These e (subtype ee))

instance
 ( Covariant Lax Monoidal Functor (AR) (AR) (P) P Void t
 , Covariant Lax Monoidal Functor (AR) (AR) (P) P Void (F'T'I'TT (T'II'I P) tt)
 ) => Mapping T'I'II T'I'II (AR) (AR) (T'I'II (AR) Unit) (t `T'TT'I` F'T'I'TT (T'II'I P) tt) where
 mapping = rewrap `identity` \source (T'I'II f) -> T'TT'I `har`
  (\x' -> Only `ho'ut` x' `ryo` Enter @t) `compose` (\x' -> Only `ho'ut` x' `ryo` Enter @(F'T'I'TT (T'II'I P) tt)) `compose` source `compose` f `identity` Unit

-- TODO: try to avoid mapping a datastructure twice here
instance
 ( Covariant Endo Semi Functor (AR) t
 , Covariant Lax Monoidal Functor (AR) (AR) (P) (W) Void t
 ) => Mapping T'I'II T'I'II (AR) (AR) (Day T'I'II (AR) (P) (W) (t `T'TT'I` F'T'I'TT (T'II'I P) t) ((t `T'TT'I` F'T'I'TT (T'II'I P) t) `L` (t `T'TT'I` F'T'I'TT (T'II'I P) t) `T` Void) e ee) (t `T'TT'I` F'T'I'TT (T'II'I P) t) where
 mapping = rewrap `identity` \source -> rewrap `identity` \case
  These (These (T'TT'I e) (Label (T'TT'I ee))) (T'I'II f) ->
    (day @T'I'II @(AR) @Void @t @t @(P) @(W) identity
     (\case
      ...
      U_T'I'II_UT'I'II (That x) -> day @T'I'II @(AR) @Void @(F'T'I'TT (T'II'I P) t) @(F'T'I'TT (T'II'I P) t) @(P) @(W) identity (source `compose` f) (fio @(AR) subtype x)
     )
      (These e (subtype @(AR) ee))
    )
...
instance
 ...
 -- , Covariant Monoidal Functor (AR) (AR) (P) (W) Void (F'T'I'TT (T'II'I P) t)
 ) => Mapping T'I'II T'I'II (AR) (AR) (Day T'I'II (AR) (P) (W) (F'T'I'TT (T'II'I P) t) (F'T'I'TT (T'II'I P) t `L` F'T'I'TT (T'II'I P) t `T` Void) e ee) (F'T'I'TT (T'II'I P) t) where
 mapping = rewrap `identity` \source -> rewrap `identity` \case
  These (These e ee) (T'I'II f) ->
   let These e__ e_ = supertype `compose` supertype `compose` supertype `compose` supertype `identity`e in
   let These ee__ ee_ = supertype `compose` supertype `compose` supertype `compose` supertype `compose` supertype `identity`ee in
   Recursive `compose` T'TT'I `compose` T'II'I `identity`These
    (day @T'I'II @(AR) @Void @t @t @(P) @(W) identity
     (supertype @(AR) `compose` \case
      U_T'I'II_UT'I'II (This (This x)) -> F'T'I'TT x `yo` source `compose` f `compose` U_T'I'II_UT'I'II `compose` This `compose` This
      U_T'I'II_UT'I'II (This (That x)) -> F'T'I'TT x `yo` source `compose` f `compose` U_T'I'II_UT'I'II `compose` This `compose` That
      U_T'I'II_UT'I'II (That (These x xx)) -> day @T'I'II @(AR) @Void @(F'T'I'TT (T'II'I P) t) @(F'T'I'TT (T'II'I P) t) @(P) @(W) identity (source `compose` f) (F'T'I'TT x `hjd` subtype (F'T'I'TT xx))
     )
     `identity`These e__ (subtype ee__))
...
instance Mapping T'I'II T'I'II (AT) (AT) (P'I'II e) I where
 mapping = rewrap `compose` rewrap `identity` \source (T'I'II (These e x)) ->
   let s = source x in Identity (this s) `hjd` (T'I'II `compose` (e `hjd`) `compose` that s `compose` supertype)

instance Mapping T'I'II T'I'II (AT) (AT) (T'II'I (P) e) I where
 mapping = rewrap `compose` rewrap `identity` \source (T'II'I (These x e)) ->
   let s = source x in Identity (this s) `hjd` (T'II'I `compose` (`hjd` e) `compose` that s `compose` supertype)
...
instance (e ~ ee) =>
 ...
 mapping = rewrap `identity` \source -> rewrap `compose` rewrap `identity` \(T'I'TT'II'I state) old ->
    ...
    let These res new = supertype (supertype (supertype trn)) btw in
...
instance (e ~ ee) => Mapping T'I'II T'I'II (AR) (AR)
 ...
 mapping = rewrap `identity` \source -> rewrap `compose` rewrap `identity` \(T'I'TT'II'I state) old ->
    let These trn btw = state old in
    let These res _ = supertype (supertype (supertype trn)) btw in
...
instance (Covariant Lax Monoidal Functor (AR) (AR) (P) (P) Void t, e ~ ee)
 ...
 mapping = rewrap `identity` \source (T'I'II (T'I'TT'II'I x)) ->
  ...
  `identity` ((\x' -> Only `ho'ut` x' `ryo` Enter) `compose` map @T'I'II @T'I'II source `compose` subtype @_ @(T'II'I _ _ _) `compose` x)
...
instance (i ~ ii)
 ...
 mapping = rewrap `identity` \source ->
  rewrap `identity` \x i ->
   source `har___` supertype x i `yoir` Unit
...
instance {-# OVERLAPS #-}
 ...
 mapping = rewrap `identity` \source -> rewrap `compose` rewrap `identity`
  \(T'I'II f) e -> f e `yo` supertype @(AR) `ho` supertype @(AR) `ho` (`har` e) `ho` source
...
instance {-# OVERLAPPABLE #-}
 ...
 mapping = rewrap `identity` \source -> rewrap `compose` rewrap `identity`
  \(T'I'II f) e ->
   map @T'I'II @T'I'II @AR @AR @(t `T'TT'I` t `L` t `T` Void) @t source `compose` subtype
   `compose` map @T'I'II @T'I'II @AR @AR @t @t (subtype @AR @(t `L` t `T` Void `T` _) `compose` yi e `compose` supertype `compose` supertype `compose` supertype)
   `identity`f e
...
instance
 ...
 mapping = rewrap `identity` \source -> rewrap `compose` rewrap `identity`
  ...
  `compose` subtype @(AR) @(t `T'TT'I` t `L` t `T` Void `T'I_` _)
  `compose` map @T'I'II @T'I'II @(AR) @(AR) @t @t
   (subtype @(AR) @(t `L` t `T` Void `T` _)
    `compose` fd @(AR) @(AR) (supertype @(AR) @(T'TTT'TT'I (T'I'II (AR) btw) (T'II'I (P) new) t _)
    `compose` fo source
    `compose` supertype @(AR) @(_ `L` _ `T` Void `T` _)))
  `compose` x
 ...
 (T'TTT'TT'I (T'I'II (AR) e) (T'II'I (P) e) tt) where
  mapping = rewrap `identity` \source -> rewrap `compose` rewrap `identity` \(T'I'II x) ->
    \old -> x old `yok` \(T'II'I (These (Label @_ @_ @Void (T'I'II (T'I'TT'II'I f))) btw))
      -> (Label @_ @_ @Void `compose` (\x' -> Only `ho'ut` x' `ryo` Enter @tt)) `identity` (T'II'I (f btw) `yo` source)
 ...
 (T'TTT'TT'I (T'I'II (AR) e) (T'II'I (P) e) tt) where
  mapping = rewrap `identity` \source -> rewrap `compose` rewrap `identity` \(T'I'II x) ->
    \old -> x old `yok` \(T'II'I (These (Label @_ @_ @(Void `P` Void) (T'I'II (T'I'TT'II'I f))) btw))
      -> (Label @_ @_ @Void `compose` (\x' -> Only `ho'ut` x' `ryo` Enter @tt)) `identity`(T'II'I (f btw `yio'ut` old) `yo` source)
...
instance
 ...
 mapping = rewrap `identity` \source -> rewrap `identity`
  map @T'I'II @T'I'II @target @target @t
   (component @target @(tt `T'TT'I` tt `L` tt `T` l) @tt `compose` subtype @target
    `compose` map @T'I'II @T'I'II @target @target @tt
     (subtype @target @(tt `L` tt `T` l `T` _)
      `compose` wrapped (map @T'I'II @T'I'II @target @target @(ttt `T'TT'I` tt `L` tt `T` l `L` ttt `T` l) @(ttt `TT'T'I` tt) source)
      `compose` map @T'I'II @T'I'II @target @target @ttt (subtype)
     )
    )
...
instance
 ...
 mapping = rewrap `identity` \source -> rewrap `identity`
  map @T'I'II @T'I'II @target @target @t @t
   (subtype @target @(TT'T'I _ _ _)
    `compose` component @target @(tt't `T'TT'I` tt't `L` tt't `T` l) @tt't
    `compose` subtype @target @(tt't `T'TT'I` tt't `L` tt't `T` l `T'I_` _)
    `compose` map @T'I'II @T'I'II @target @target @tt't @tt't (subtype @target @(tt't `L` tt't `T` l `T` _))
    `compose` map @T'I'II @T'I'II @target @target @tt't
     ...
     `compose` map @T'I'II @T'I'II @target @target @(tt'tt) @(tt'tt)
      (subtype @target `compose` subtype @target @(tt't `L` tt't `T` l `T` _))
    )
    `compose` supertype @target @(TT'T'I tt'tt tt't _)
    `compose` map @T'I'II @T'I'II @target @target @(TT'T'I tt'tt tt't) @(TT'T'I tt'tt tt't)
     ...
     `compose` map @T'I'II @T'I'II @target @target @ttt @ttt subtype)
   )
  `compose` supertype @target
  ...
  map @T'I'II @T'I'II @target @target @t @t
   (subtype @target @(TT'T'I _ _ _)
    `compose` map @T'I'II @T'I'II @target @target @ttt'tt
     ...
     `compose` subtype @target @(T'TT'I _ _ _)
     `compose` map @T'I'II @T'I'II @target @target @ttt't (subtype @target @(ttt't `L` ttt't `T` l `T` _))
     )
    `compose` supertype @target @(TT'T'I ttt't ttt'tt _)
    `compose` map @T'I'II @T'I'II @target @target @(ttt't `TT'T'I` ttt'tt) @(ttt't `TT'T'I` ttt'tt)
     (wrapped (map @T'I'II @T'I'II @target @target @(tt `T'TT'I` ttt't `L` ttt't `T` l `L` tt `T` l) @(tt `TT'T'I` ttt't) source) `compose` map @T'I'II @T'I'II @target @target @tt @tt subtype)
   )
  `compose` supertype @target
...
instance
 ...
 mapping = rewrap `identity` \source -> subtype @(AR) @((tt `TT'T'I` t) _)
...
-- instance Mapping T'I'II T'I'II (AR) (AR) (T'II'I (P) e `T'TT'I` L (S'I'II () ()) tt) (T'II'I (P) e `TT'T'I` tt) =>
 ...
 -- mapping = rewrap `identity` \source (T'TT'I (T'I'II (T'I'TT'II'I x))) ->
  -- T'TTT'TT'I `compose` T'I'II `identity` \old -> wrapped @(AR)
   -- `har` map @T'I'II @T'I'II @(AR) @(AR) @(T'II'I (P) e `T'TT'I` L (S'I'II () ()) tt) @(T'II'I (P) e `TT'T'I` tt) source
   -- `har` T'II'I (x old)
...
instance Covariant Lax Monoidal Functor (AR) (AR) (P) P Void t =>
 ...
 mapping = rewrap `identity` \source -> rewrap `identity` \f -> T'I'II `identity` \_ -> (\x' -> Only `ho'ut` x' `ryo` Enter) `compose` source `har` f Unit
...
--  mapping = rewrap `identity` \source -> rewrap
--   `har` subtype @target @(T'I'TT'II'I _ _ _ _)
...
instance
 ...
 mapping = rewrap `identity` \source -> rewrap
  `har` subtype @(AR) @(T'I'TT'II'I _ _ _ _)
...
instance
 ...
 mapping = rewrap `identity` \source -> subtype @target @(T'TTT'TT'I _ _ _ _)
...
instance Covariant Lax Monoidal Functor (AR) (AR) (P) P Void t =>
 ...
 mapping = rewrap `identity` \source -> rewrap `identity` \case
  T'I'II (This e) -> ((\x' -> Only `ho'ut` x' `ryo` Enter) `ha` T'I'II) (This e)
  T'I'II (That x) -> supertype (supertype x) `yo` source `ho` That  `ho` T'I'II
 ...
 mapping = rewrap `identity` \source -> \(T'TT'I x) ->
  x `yok_` Label @_ @_ @Void
    `ha__` constant @(AR) (map @T'I'II @T'I'II source (T'TT'I x))
      `bt'has` (\x' -> Only `ho'ut` x' `ryo` Enter @(T'I'II (T'I'TT'II'I (AR) (P)) i)) `ha` source

instance Mapping T'I'II T'I'II (AR) (AR)
 (T'I'II (T'I'TT'II'I (AR) (P)) i `T'TT'I` I `L` I `T` Recursive)
 (T'I'II (T'I'TT'II'I (AR) (P)) i) where
 mapping = rewrap `identity` \source -> \(T'TT'I x) ->
  x `yok` Label @_ @_ @Void `ha` constant @(AR) (map @T'I'II @T'I'II @_ @_ @_ @(T'I'II (T'I'TT'II'I (AR) (P)) i) source (T'TT'I x)) `ha` supertype @(AR) `ha` supertype @(AR)
...
instance
 ...
 mapping = rewrap `identity` \source -> \(T'TT'I x) ->
  x `yok_` Label @_ @_ @Void
    `ha__` constant @(AR) (map @T'I'II @T'I'II source (T'TT'I x))
      `bt'has` (\x' -> Only `ho'ut` x' `ryo` Enter @(T'TTT'TT'I (T'I'II (AR) i) (T'II'I (P) i) t)) `ha` source
...
instance Covariant Lax Monoidal Functor (AR)  (AR) (P) P Void t =>
 ...
 mapping = rewrap `identity` \source (T'I'II f) ->
  TT'T'I `compose` (\x' -> Only `ho'ut` x' `ryo` Enter) `compose` T'I'II `compose` That `compose` source `identity`f Unit
...
--  mapping = rewrap `identity` \source -> rewrap
--   `har` component @target @(t `T'TT'I` t `L` t `T` Void) @t
--   `compose` subtype @target
--   `compose` map @T'I'II @T'I'II @target @target @t @t
--   (subtype @_ @(t `L` t `T` Void `T` _)
--    `compose` map @T'I'II @T'I'II @target @target @t @t
--     (map @T'I'II @T'I'II @target @target @(tt `T'TT'I` tt) @tt source `compose` subtype @target)
...
--      (subtype @target @(t `L` t `T` Void `L` tt `T` Void `T` _) `compose` subtype @target @(t `L` t `T` Void `T` _) `compose` supertype `compose` supertype)
--    )
...
--   T'I'II `identity` \e -> x `yo` source `compose` (`har` e) `compose` supertype
...
-- instance {-# OVERLAPS #-} Component (AR) (T'TT'I t tt) t =>
 ...
 -- mapping = rewrap `identity` \source ->
  -- map @T'I'II @T'I'II @(AR) @(AR) @(T'TT'I t tt) @t source `compose` rewrap @_ @(AR) (fo @(AR) supertype)

instance
 ( Covariant Lax Monoidal Functor (AR) (AR) (P) P Void t
 , Mapping T'I'II T'I'II (AR) (AR) (T'I'II (AR) Unit) t
 ) => Mapping T'I'II T'I'II (AR) (AR) (T'I'II (AR) Unit) (t `L` t `T` l) where
 mapping = rewrap `identity` \source -> rewrap `identity` \f -> (\x' -> Only `ho'ut` x' `ryo` Enter) `compose` source `identity` f Unit
...
instance
 ...
 mapping = rewrap `identity` \source -> rewrap `har`
...
type instance Supertype Void = Void

instance Elicitable T'I'II (AR) Void where
 elicit = T'I'II identity

type instance Supertype (i `P` Void) = Void

instance Elicitable T'I'II (AR) (i `P` Void) where
 elicit = T'I'II that

type instance Supertype (i `S` Void) = i

instance Elicitable T'I'II (AR) (i `S` Void) where
 elicit = T'I'II (identity `has` initial)
