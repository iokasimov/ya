...
instance (Precategory into, forall e . Wrapper into (I e)) 
 => Mappings U_I_II U_I_II into into I I where
...
instance
 ...
 ) => Mappings U_I_II U_I_II into into (I `T'TT'I` l `L` ll `L` t) (I `TT'T'I` t) where
...
instance
 ...
 ) => Mappings U_I_II U_I_II from into (t `T'TT'I` tt) (t `T'TT'I` tt) where
...
instance
 ...
 ) => Mappings U_I_II U_I_II from into (t `TT'T'I` tt) (t `TT'T'I` tt) where
 mapping = rewrap / \from -> wrap @into `compose` (map @U_I_II @U_I_II @into @into `compose` map @U_I_II @U_I_II @from @into) from `compose` unwrap @into

instance
 ( Covariant Semi Functor from into t
 , forall e . Wrapper into (l `L` t `WR` e)
 ) => Mappings U_I_II U_I_II from into (l `L` t) (l `L` t) where
...
instance
 ...
 ) => Mappings U_I_II U_I_II from into (U_I_II (U_I_T_II t u) e) (U_I_II (U_I_T_II t u) e) where
 mapping = rewrap / \from ->
...
instance
 ...
 ) => Mappings U_I_II U_I_II from into (U_II_I (U_I_T_II t u) e) (U_II_I (U_I_T_II t u) e) where
 mapping = rewrap / \from ->
...
instance
 ...
 ) => Mappings U_I_II U_I_II from into (T'TTT'TT'I t h tt) (T'TTT'TT'I t h tt) where
...
instance
 ...
 ) => Mappings U_I_II U_I_II from into (U_T_I_TT_I u t tt) (U_T_I_TT_I u t tt) where
 mapping = rewrap / \from -> rewrap /
...
instance
 ...
 ) => Mappings U_I_II U_I_II from AR (U_T_I_TT_I u t tt `T'TT'I` ttt) (U_T_I_TT_I u t tt `TT'T'I` ttt) where
 mapping = rewrap / \from -> rewrap /
  day @U_I_II @from @ttt @u @u (wrap @_ @(U_T_I_TT_I u t tt _)) identity `compose`
   i_ (map @U_I_II @U_I_II @AR @AR
    (wrapped (map @U_I_II @U_I_II @from @AR @(t `T'TT'I` ttt) @(t `TT'T'I` ttt) from))) `compose`
   _i (map @U_I_II @U_I_II @AR @AR
    (wrapped (map @U_I_II @U_I_II @from @AR @(tt `T'TT'I` ttt) @(tt `TT'T'I` ttt) from))) `compose`
...
-- instance
 ...
 -- ) => Mappings U_I_II U_I_II from into (U_T_I_TT_I u t tt `T'TT'I` ttt) (U_T_I_TT_I u t tt `TT'T'I` ttt where
 -- mapping = rewrap / \from -> rewrap /
...
instance Mappings U_I_II U_I_II AR AR (U_I_II P e `T'TT'I` U_I_II AR e) I where
 mapping = rewrap / \from -> rewrap / \(U_I_II (These e (U_I_II f))) -> from (f e)

instance Mappings U_I_II U_I_II AR AR I (U_I_II AR e `T'TT'I` U_I_II P e) where
 mapping = rewrap / \from -> rewrap / \x -> U_I_II / \e -> U_I_II (These e (from x))

instance Mappings U_I_II U_I_II AR AR I (U_I_II AR e `T'TT'I` U_II_I P e) where
 mapping = rewrap / \from -> rewrap / \x -> U_I_II / \e -> U_II_I (These (from x) e)

instance Mappings U_I_II U_I_II AR AR (U_II_I P e `T'TT'I` U_I_II AR e) I where
 mapping = rewrap / \from -> rewrap / \(U_II_I (These (U_I_II f) e)) -> from (f e)

instance Mappings U_I_II U_I_II AR AR (U_I_II P e) (U_I_II P e) where
 mapping = rewrap / \from -> rewrap / \case
  These e x -> These e (from x)

instance Mappings U_I_II U_I_II AR AR (U_II_I P o) (U_II_I P o) where
 mapping = rewrap / \from -> rewrap / \case
  These x e -> These (from x) e

instance Mappings U_I_II U_I_II AR AR (U_I_II S o) (U_I_II S o) where
 mapping = rewrap / \from -> rewrap / \case
  That x -> That (from x)
  This e -> This e

instance Mappings U_I_II U_I_II AR AR (U_II_I S o) (U_II_I S o) where
 mapping = rewrap / \from -> rewrap / \case
  This x -> This (from x)
  That e -> That e
...
instance
 ...
 ) => Mappings U_I_II U_I_II from AR (U_I_I u `T'TT'I` t) (U_I_I u `TT'T'I` t) where
 mapping = rewrap / \from -> rewrap /
...
instance
 ...
 , Mappings U_I_II U_I_II AR AR (t `T'TT'I` tt) (t `TT'T'I` tt)
 ) => Mappings U_I_II U_I_II AR AR
...
--  Mappings U_I_II U_I_II AR AR (U_II_I P e `T'TT'I` tt) (U_II_I P e `TT'T'I` tt) where
...
instance Mappings U_I_II U_I_II
 (U_I_UU_II_I AR P) AR
 (U_I_II (U_I_UU_II_I AR P) e)
 (U_I_II (U_I_UU_II_I AR P) e) where
...
-- TODO: it doesn't work correctly?
instance Mappings U_II_I U_I_II
 (U_I_UU_II_I AR P) AR
...
instance
 ...
 ) => Mappings U_I_II U_I_II from into (R_U_I_T_I u t) (R_U_I_T_I u t) where
 mapping = rewrap / \from ->
...
instance {-# OVERLAPPABLE #-} Mappings U_I_II U_I_II AR AR (U_I_II AR a) (U_I_II AR a) where
 mapping (U_I_II from) = U_I_II / \(U_I_II between) -> U_I_II (\x -> from (between x))

instance Mappings U_II_I U_I_II AR AR (U_II_I AR o) (U_II_I AR o) where
 mapping (U_II_I from) = U_I_II / \(U_II_I between) -> U_II_I (\x -> between (from x))

instance Category AR where
 identity = \x -> x

instance Mappings U_I_II U_I_II AR into t tt
 => Mappings U_1_I U_I_II AR into t tt where
  mapping (U_1_I f) = mapping (U_I_II (f `compose` terminal))

-- instance Mappings U_I_II U_I_II AR AR (U_1_I (->) e) (U_1_I (->) e) where
--  mapping = rewrap / \from (U_1_I x) -> U_1_I / from x

instance Mappings U_I_II U_I_II AR AR I (U_I_II AR e) where
 mapping = rewrap / \from (Identity x) -> U_I_II / \_ -> from x

instance Mappings U_I_II U_I_II AR AR I (U_I_I P) where
 mapping (U_I_II from) = U_I_II / \(Identity x) -> U_I_I (These (from x) (from x))

-- TODO: redefine using limits
instance Mappings U_I_II U_I_II AR AR (U_I_I P) (U_I_I P) where
 mapping (U_I_II from) = U_I_II / \(U_I_I (These x y)) -> U_I_I (These (from x) (from y))

instance Mappings U_I_II U_I_II AR AR (U_I_II P e) I where
 mapping (U_I_II from) = U_I_II / \(U_I_II (These _ x)) -> Identity (from x)

instance Mappings U_I_II U_I_II AR AR (U_II_I P e) I where
 mapping (U_I_II from) = U_I_II / \(U_II_I (These x _)) -> Identity (from x)

instance Mappings U_I_II U_I_II AR AR (U_I_I S) I where
 mapping (U_I_II from) = U_I_II / \case
  U_I_I (This x) -> Identity (from x)
  U_I_I (That x) -> Identity (from x)

instance Mappings U_I_II U_I_II AR AR I (U_I_II S e) where
 mapping (U_I_II from) = U_I_II / \(Identity x) -> U_I_II (That (from x))

instance Mappings U_I_II U_I_II AR AR I (U_II_I S e) where
 mapping (U_I_II from) = U_I_II / \(Identity x) -> U_II_I (This (from x))

instance Mappings U_I_II U_I_II AT AR (U_I_II AT origin) (U_I_II AT origin) where
...
instance Mappings U_II_I U_I_II AT AR (U_II_I AT origin) (U_II_I AT origin) where
...
-- instance Mappings U_I_II U_I_II (W_I_II_II (U_I_UU_III_U_II_I (->) P)) (->) Identity (U_I_I P) where
 -- mapping = rewrap / \(W_I_II_II (U_I_UU_III_U_II_I from)) (Identity old) -> U_I_I / These
  -- (wrapped (left @U_I_II @(->) identity) (from old))
  -- (wrapped (left @U_I_II @(->) identity) (from old))

-- instance Mappings U_II_I U_I_II (W_I_II_II (U_I_UU_III_U_II_I (->) P)) (->) (This (->) e) (This (->) e) where
 -- mapping = rewrap / \(W_I_II_II (U_I_UU_III_U_II_I from)) ->
  -- map @U_II_I @U_I_II / (\(These x _) -> x) `compose` from

instance Mappings U_I_II U_I_II AR AR (Day U_I_II AR P P I I e ee) I where
 mapping = rewrap / \from -> rewrap / \case
  These (These (Identity e) (Identity ee)) (U_I_II f) -> from (f (These e ee))

instance Mappings U_I_II U_I_II AR AR (U_I_II AR Unit) I where
 mapping = rewrap / \from (U_I_II f) -> Identity (from (f Unit))

instance Mappings U_I_II U_I_II AR AR (Day U_I_II AR P P (U_II_I S e) (U_II_I S e) ee eee) (U_II_I S e) where
 mapping = rewrap / \from -> rewrap / \case
  These (These (U_II_I (This ee)) (U_II_I (This eee))) (U_I_II f) -> This (from (f (These ee eee)))
  These (These (U_II_I (That e)) _) _ -> That e

instance Mappings U_I_II U_I_II AR AR (U_I_II AR Unit) (U_II_I S e) where
 mapping = rewrap / \from (U_I_II f) -> U_II_I (This (from (f Unit)))

instance Mappings U_I_II U_I_II AR AR (Day U_I_II AR P P (U_I_II S e) (U_I_II S e) ee eee) (U_I_II S e) where
 mapping = rewrap / \from -> rewrap / \case
...
instance Mappings U_I_II U_I_II AR AR (Day U_I_II AR P SP (U_I_II S e) (U_I_II S e) ee eee) (U_I_II S e) where
 mapping = rewrap / \from -> rewrap / \case
...
instance Mappings U_I_II U_I_II AR AR (U_I_II AR Unit) (U_I_II S e) where
...
instance Mappings U_I_II U_I_II AR AR (U_I_II AR Void) (U_II_I S Unit) where
...
instance Mappings U_I_II U_I_II AR AR (U_I_II AR Void) (U_I_II S Unit) where
 mapping = rewrap / \_ _ -> U_I_II (This Unit)

instance Mappings U_I_II U_I_II AR AR (U_I_II AR (S Unit Unit)) (U_I_I P) where
 mapping = rewrap / \from -> rewrap / \f -> These
  (from `compose` f / This Unit)
  (from `compose` f / That Unit)

instance Mappings U_I_II U_I_II AR AR (U_I_I P) (U_I_II AR (S Unit Unit)) where
...
-- instance Monoidal U_I_II Functor AR P S t
 -- => Mappings U_I_II U_I_II AR AR (U_I_II AR Void) (U_I_I P `T'TT'I` t) where
