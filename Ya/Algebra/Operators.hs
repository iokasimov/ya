...
infixl 9 `ho`, `ho'ho`, `ho'ho'ho`, `ho'ho'hu`, `ho'ho'yoi`, `ho'yio'yoi`, `ho'yio'yui`, `ho'ho'yui`, `ho'hu`, `ho'ha`, `ho'ha'he`, `ho'ha'he'he`, `ho'yo`, `ho'yioi`, `ho'yu`, `ho'yoi`, `ho'yui`, `ho'yok`, `ho'yuk`, `ho'yokl`, `ho'yokl'yokl`, `ho'yokl'yukl`, `ho'yukl`
 , `ho'he`
 , `ho'he'he`
 , `ho'he'he'he`
 , `ho'he'he'hv`
...
infixl 7 `yai`, `yai'yai`, `yai'yukl`

infixl 7 `yui` --, `yui'he`

infixl 7 `yio`, `yio'yo`, `yio'yokl'yokl`, `yio'yokl'yukl`, `yio'yukl`, `yio'yp`, `yio'yio'yoi`, `yio'yio'yui`
...
yai'yai :: forall from into t tt e ee a o .
 ...
 Elicitable U_I_II into (U_II_I t ee (tt o e)) =>
 Elicitable U_II_I into (U_II_I from (tt a e) (tt o e)) =>
...
yio'yio'yoi x = fai @(->) @(->) (fio @from `compose` foi @from) (ho @u @from x)

ho'yio'yoi = yio'yio'yoi
yio'ho'yoi = yio'yio'yoi
...
-- TODO: try to generalize
yp'yok :: forall e ee from into t tt l o .
 Covariant Monoidal Functor (->) (->) P P t =>
 Covariant Endo Semi Functor into tt =>
 Covariant Endo Semi Functor into t =>
 Covariant Yoneda Functor from into t =>
 Covariant Endo Transformation Functor into (T'TT'I t (L l tt)) t =>
 Elicitable U_II_I into (U_I_II from (e `P` ee) (L l tt o)) =>
 (forall eee . Wrapper into (T'TT'I t (L l tt) eee)) =>
 t e `P` t ee -> into (from (e `P` ee) (L l tt o)) (t o)
...
yio'yokl'yokl
 ...
 (forall e . Wrapper into (U_I_II from (t (tt a)) (ttt (t (tt e))))) =>
 (forall e . Wrapper into (U_I_II u i (ttt (t (tt e))))) =>
...
yio'yokl'yukl
 ...
 (forall e . Wrapper into (U_I_II (->) (t (tt a)) (ttt (t (tt e))))) =>
 (forall e . Wrapper into (U_I_II u i (ttt (t (tt e))))) =>
