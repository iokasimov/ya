...
infixl 9 `_'`, `i`, `hu`, `hu'`, `v`, `ho`, `ho'`, `ha`, `ha'`, `hv`, `_j`, `j'`, `j'_j'`, `ha_ha`, `ha'_ha`, `ho_ha`, `ho_ho`, `ha_ho`, `ho_yo`, `ho'_yo`, `ho_yioi`, `ha_yo`, `ha_yioi`, `ho_yu`, `ho_yi'_ho`, `ho_yokl`, `ho_yukl`, `ho_yoklKL`, `ha_yokl`, `ha_yukl` --, `ho_rwr_yoi`, `ho_rwr_yio`
